...
#define type 1 //type 0--3; type=2 is SSD1306(I2C); type=3 is SH1106(I2C);
...
#define type 0 //type 0--3;  type=0 is SSD1306(SPI) ；type=1 is SH1106(SPI);type=2 is SSD1306(I2C); type=3 is SH1106(I2C);
#if(type==0)
     U8G2_SSD1306_128X64_NONAME_F_4W_SW_SPI u8g2(U8G2_R0, /* clock*/15, /* data*/23,/*CS*/2,/*DC*/4 , U8X8_PIN_NONE);
#elif(type==1)
      U8G2_SH1106_128X64_NONAME_F_4W_SW_SPI u8g2(U8G2_R0, /* clock*/15, /* data*/23,/*CS*/2,/*DC*/4 , U8X8_PIN_NONE);
#elif(type==2)
       U8G2_SSD1306_128X64_NONAME_F_SW_I2C u8g2(U8G2_R0, /* clock22*/SCL, /* data21*/SDA,  U8X8_PIN_NONE);
#elif(type==3)   
        U8G2_SH1106_128X64_NONAME_F_SW_I2C u8g2(U8G2_R0, /* clock22*/SCL, /* data21*/SDA,  U8X8_PIN_NONE) ;
#endif
 ...
 // put your main code here, to run repeatedly:
  ...
  u8g2.clear();
      u8g2.setFont(u8g2_font_unifont_t_chinese2); 
       ...
       u8g2.print("你好世界"); 
       u8g2.drawStr(10,35,"Just Do It!"); 
       u8g2.drawStr(10,50,"www.heltec.cn"); 
       u8g2.sendBuffer();
  delay(2000);
}
